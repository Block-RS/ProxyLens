...
INFURA_MAINNET = "mainnet.infura.io/v3/"
INFURA_ROPSTEN = "ropsten.infura.io/v3/"
INFURA_INFURANET = "infuranet.infura.io/v3/"
INFURA_KOVAN = "kovan.infura.io/v3/"
INFURA_RINKEBY = "rinkeby.infura.io/v3/"
INFURA_RPC_PORT = 443
...
class EthereumExplorerRPC(Explorer):
    ...
    """
    def __init__(self, host='localhost', port=GETH_DEFAULT_RPC_PORT, tls=False, max_retries=3, full_url=None):
        Explorer.__init__(self, host=host, port=port, tls=tls, max_retries=max_retries,full_url=full_url)
